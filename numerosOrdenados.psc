Algoritmo numerosOrdenados
	...
	Definir  numero1, numero2, numero3, ordernados, numeroIgual, resultadoOrdenados  Como Real;
	...
	resultadoOrdenados =    numeroIgual;
	Imprimir "El numero repetido es: " , resultadoOrdenados;
